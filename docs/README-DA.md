<p align="center">
  ...
  <b>Vi har brug for din hjælp til at oversætte denne README, <a href="https://github.com/bgdesk/bgdesk/tree/master/src/lang">BGDesk UI</a> og <a href=" https://github.com/bgdesk/doc.bgdesk.com">Dokument</a> til dit modersmål</b>
</p>
...
- **[libs/hbb_common](https://github.com/bgdesk/bgdesk/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs funktioner til filoverførsel og nogle andre hjælpefunktioner
- **[libs/scrap](https://github.com/bgdesk/bgdesk/tree/master/libs/scrap)**: Skærmbillede
- **[libs/enigo](https://github.com/bgdesk/bgdesk/tree/master/libs/enigo)**: platform specifik tastatur/mus kontrol
- **[src/ui](https://github.com/bgdesk/bgdesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/bgdesk/bgdesk/tree/master/src/server)**: lyd/udklipsholder/input/videotjenester og netværksforbindelser
- **[src/client.rs](https://github.com/bgdesk/bgdesk/tree/master/src/client.rs)**: starte en peer-forbindelse
- **[src/rendezvous_mediator.rs](https://github.com/bgdesk/bgdesk/tree/master/src/rendezvous_mediator.rs)**: Kommuniker med [bgdesk-server](https://github.com/bgdesk/bgdesk-server), vent på direkte fjernforbindelse (TCP-hulning) eller relæforbindelse
- **[src/platform](https://github.com/bgdesk/bgdesk/tree/master/src/platform)**: Javascript til Flutter webklient
