...
<p dir="rtl" align="center"><b>برای ترجمه این سند (README)، <a href="https://github.com/bgdesk/bgdesk/tree/master/src/lang" dir="rtl">رابط کاربری BGDesk</a>، <a href="https://github.com/bgdesk/doc.bgdesk.com" dir="rtl">و مستندات آن</a> به زبان مادری شما به کمکتان نیازمندیم. </b></p>
...
[ سرورrendezvous/relay  خود را بنویسید](https://github.com/bgdesk/bgdesk).

ما از مشارکت همه استقبال می کنیم. برای راهنمایی جهت مشارکت به[`docs/CONTRIBUTING.md`](CONTRIBUTING.md) مراجعه کنید.

[راست‌دسک چطور کار می کند؟](https://github.com/bgdesk/bgdesk/wiki/How-does-BGDesk-work%3F)

[دریافت نرم‌افزار](https://github.com/bgdesk/bgdesk/releases)
