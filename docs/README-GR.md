<p align="center">
  ...
  <b>Χρειαζόμαστε τη βοήθειά σας για να μεταφράσουμε αυτό το αρχείο README, το <a href="https://github.com/boagestao/bgdesk/tree/master/src/lang">RustDesk UI</a> και το <a href="https://github.com/bgdesk/doc.bgdesk.com">Doc</a> στη μητρική σας γλώσσα</b>
</p>
...
[![RustDesk Server Pro](https://img.shields.io/badge/RustDesk%20Server%20Pro-%CE%A0%CF%81%CE%BF%CE%B7%CE%B3%CE%BC%CE%AD%CE%BD%CE%B5%CF%82%20%CE%94%CF%85%CE%BD%CE%B1%CF%84%CF%8C%CF%84%CE%B7%CF%84%CE%B5%CF%82-blue)](https://bgdesk.com/pricing.html)
