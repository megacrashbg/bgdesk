<p align="center">
  ...
  <b>Нам нужна ваша помощь в переводе этого README, <a href="https://github.com/boagestao/bgdesk/tree/master/src/lang">интерфейса RustDesk</a>
...
[**Как работает RustDesk?**](https://github.com/boagestao/bgdesk/wiki/How-does-RustDesk-work%3F) (Документация на английском языке)
...
## [Сборка](https://bgdesk.com/docs/ru/dev/build/)
