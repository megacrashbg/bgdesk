<p align="center">
  ...
  <b>Kami membutuhkan bantuanmu untuk menterjemahkan file README dan <a href="https://github.com/bgdesk/bgdesk/tree/master/src/lang">BGDesk UI</a> ke Bahasa Indonesia</b>
</p>
...
[**UNDUH BINARY**](https://github.com/bgdesk/bgdesk/releases)
...
- **[libs/hbb_common](https://github.com/bgdesk/bgdesk/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs functions untuk transfer file, dan beberapa fungsi utilitas lainnya
- **[libs/scrap](https://github.com/bgdesk/bgdesk/tree/master/libs/scrap)**: screen capture
- **[libs/enigo](https://github.com/bgdesk/bgdesk/tree/master/libs/enigo)**: spesifikasi platform keyboard/mouse control
- **[src/ui](https://github.com/bgdesk/bgdesk/tree/master/src/ui)**: GUI
- **[src/server](https://github.com/bgdesk/bgdesk/tree/master/src/server)**: audio/clipboard/input/video services, dan network connections
- **[src/client.rs](https://github.com/bgdesk/bgdesk/tree/master/src/client.rs)**: start a peer connection
- **[src/rendezvous_mediator.rs](https://github.com/bgdesk/bgdesk/tree/master/src/rendezvous_mediator.rs)**: Komunikasi dengan [bgdesk-server](https://github.com/bgdesk/bgdesk-server), menunggu untuk remote direct (TCP hole punching) atau relayed connection
- **[src/platform](https://github.com/bgdesk/bgdesk/tree/master/src/platform)**: kode khusus platform
