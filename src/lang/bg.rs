...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС трябва да инсталирате BGDesk като системна услуга."),
        ...
        ("android_input_permission_tip2", "Моля, отидете на следващата страница със системни настройки, намерете и въведете [Installed Services], включете услугата [BGDesk Input]."),
        ...
        ("Language", "Език"),
        ("Keep BGDesk background service", "Запази BGDesk фоновата услуга"),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да натисне върху OK в прозореца на UAC при стартиран BGDesk."),
