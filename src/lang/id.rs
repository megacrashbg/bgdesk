...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan BGDesk..."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Silakan perbarui klien BGDesk ke versi {} atau lebih baru di sisi remote!"),
