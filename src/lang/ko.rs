...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "준비"),
        ("Established", "연결됨"),
        ("connecting_status", "BGDesk 네트워크로 연결중입니다..."),
        ...
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [BGDesk Input] 서비스를 켜십시오."),
        ...
        ("Turned off", "종료됨"),
        ("Language", "언어"),
        ("Keep BGDesk background service", "BGDesk 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 BGDesk 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "BGDesk Server Pro를 {} 버전 이상으로 업그레이드하십시오!"),
        ...
        ("allow-only-conn-window-open-tip", "BGDesk 창이 열려 있는 경우에만 연결 허용"),
        ...
        ("floating_window_tip", "BGDesk 백그라운드 서비스를 유지하는 것이 좋습니다."),
        ...
        ("Accessible devices", ""),
        ("View camera", "카메라 보기"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "원격 측의 BGDesk 클라이언트를 {} 버전 이상으로 업그레이드하십시오!"),
